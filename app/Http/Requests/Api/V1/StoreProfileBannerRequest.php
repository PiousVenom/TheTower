...
/**
 * @OA\Schema(
 *     schema="StoreProfileBannerRequest",
 *     required={"name", "value"},
 ...
 * )
 */
class StoreProfileBannerRequest extends FormRequest
{
    ...
    {
        return [
            'name.required'  => 'A profile banner name is required.',
    ...
    {
        return [
            'name'  => ['required', 'string', 'max:191', 'unique:profileBanners,name'],
